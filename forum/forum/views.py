...
#Preuzeto sa http://www.devinterface.com/blog/en/2013/12/come-migrare-dalle-viste-generiche-basate-su-funzioni-alle-analoghe-basate-su-classi-in-django/
...
def forums_list(request):
    ...
    callable =  SubListView.as_view(queryset=queryset)
